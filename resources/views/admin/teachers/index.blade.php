    ...
    <div class="flex">
        ...
        <main class="flex-grow lg:ml-64 p-8">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                <div>
                    <h1 class="text-3xl font-black text-on-surface">Teacher Management</h1>
                    <p class="text-on-surface/70 mt-1">Manage your teaching staff and their specialties.</p>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead class="bg-surface-container-high border-b border-outline/10">
                            <tr>
                                <th class="px-6 py-4 text-sm font-bold text-on-surface">Teacher Name</th>
                                <th class="px-6 py-4 text-sm font-bold text-on-surface">Specialty</th>
                                <th class="px-6 py-4 text-sm font-bold text-on-surface">Qualification</th>
                        ...
                        <tbody class="divide-y divide-outline/10">
                            ...
                            <tr class="hover:bg-surface-container-low transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <form action="{{ route('admin.teachers.destroy', $teacher->teacherid) }}" method="POST" onsubmit="return confirm('Delete this teacher?')">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="px-6 py-8 text-center text-on-surface/50">No teachers found.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>

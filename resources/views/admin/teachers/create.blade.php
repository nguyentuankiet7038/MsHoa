    ...
    <div class="flex">
        ...
        <main class="flex-grow lg:ml-64 p-8">
            <div class="mb-10">
                ...
                <h1 class="text-3xl font-black text-on-surface">Add New Teacher</h1>
                <p class="text-on-surface/70 mt-1">Create a new teacher profile and account.</p>
            </div>
                ...
                <form action="{{ route('admin.teachers.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="fullname" required value="{{ old('fullname') }}" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Enter teacher's full name">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="specialy" required value="{{ old('specialy') }}" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="e.g. IELTS, TOEIC">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="qualification" required value="{{ old('qualification') }}" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="e.g. Master of English">
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <textarea name="expertise" required rows="4" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Enter expertise details and short biography">{{ old('expertise') }}</textarea>
                    ...
                    <div class="pt-4 flex justify-end gap-4">
                        ...
                        <button type="submit" class="px-8 py-4 bg-primary text-on-primary rounded-xl font-bold shadow-lg hover:brightness-110 transition-all active:scale-[0.98]">Create Teacher</button>
                    </div>
                </form>
            </div>
        </main>

        ...
        <div class="w-full max-w-2xl bg-white rounded-3xl shadow-xl overflow-hidden border border-outline/10">
            <div class="bg-primary p-8 text-on-primary">
                <div class="flex items-center gap-4 mb-2">
                    ...
                    <h1 class="text-3xl font-black">Add New Course</h1>
                </div>
                <p class="text-white/80">Create a new English learning program for your students.</p>
            </div>
            ...
            <form action="{{ route('admin.courses.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="coursename" id="coursename" required class="w-full px-4 py-3 rounded-xl border border-outline/30 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="e.g. IELTS Intensive Masterclass">
                    </div>
                    <div class="space-y-2">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" id="description" rows="4" required class="w-full px-4 py-3 rounded-xl border border-outline/30 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Describe the course content and goals..."></textarea>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-sm font-bold text-on-surface/70" for="price">Price (VNĐ)</label>
                        <input type="number" name="price" id="price" required class="w-full px-4 py-3 rounded-xl border border-outline/30 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="500000">
                    </div>
                    <div class="space-y-2">
                ...
                <div class="space-y-2">
                    <label class="text-sm font-bold text-on-surface/70" for="image">Course Image</label>
                    <div class="flex items-center justify-center w-full">
                        <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-outline/30 border-dashed rounded-xl cursor-pointer bg-surface-container-low hover:bg-surface-container transition-all">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                <span class="material-symbols-outlined text-outline mb-2">cloud_upload</span>
                                <p class="text-xs text-outline font-medium">Click to upload course image</p>
                            </div>

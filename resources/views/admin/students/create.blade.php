    ...
    <div class="flex">
        ...
        <main class="flex-grow lg:ml-64 p-8">
            <div class="mb-10">
                ...
                <h1 class="text-3xl font-black text-on-surface">Add New Student</h1>
                <p class="text-on-surface/70 mt-1">Create a new student profile and account.</p>
            </div>
                ...
                <form action="{{ route('admin.students.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="fullname" required value="{{ old('fullname') }}" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Enter student's full name">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="email" name="email" required value="{{ old('email') }}" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="email@example.com">
                            @error('email') <p class="text-red-500 text-xs">{{ $message }}</p> @enderror
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-bold text-on-surface">Password</label>
                            <input type="password" name="password" required class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Min. 6 characters">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="phone" value="{{ old('phone') }}" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Enter phone number">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="date" name="dateofbirth" required value="{{ old('dateofbirth') }}" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all">
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <textarea name="address" required rows="2" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Enter full address">{{ old('address') }}</textarea>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="parentname" required value="{{ old('parentname') }}" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Enter parent name">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="parentphone" required value="{{ old('parentphone') }}" class="w-full px-4 py-3 rounded-xl border border-outline/20 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" placeholder="Enter parent phone">
                    ...
                    <div class="pt-4 flex justify-end gap-4">
                        ...
                        <button type="submit" class="px-8 py-4 bg-primary text-on-primary rounded-xl font-bold shadow-lg hover:brightness-110 transition-all active:scale-[0.98]">Create Student</button>
                    </div>
                </form>
            </div>
        </main>

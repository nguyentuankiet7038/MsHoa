...
<div class="flex min-h-screen">
    ...
    <aside class="hidden lg:flex flex-col w-64 h-screen fixed left-0 top-0 pt-20 pb-4 bg-surface-container-low border-r border-outline-variant z-40">
        ...
        <nav class="flex-1 space-y-1">
            ...
            <a class="flex items-center {{ request()->routeIs('admin.help-center.*') ? 'bg-secondary-container text-on-secondary-container' : 'text-on-surface-variant' }} px-4 py-3 mx-2 hover:bg-surface-container-high rounded-xl transition-transform active:scale-95" href="{{ route('admin.help-center.index') }}">
